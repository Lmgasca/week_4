...
print(sentence[25:38].upper()) # prints COMMUNICATIONS

#join the following list into a string, separating each item with a space
...
split_sentence4 = sentence.split()
print(split_sentence4)

text6 = "If the implementation is hard to explain, it might be a bad idea."
new_text = text6.replace("hard","easy").replace("bad","good")
print(new_text) #replaces the text

# concatenate the text "Repitition" 15 times
